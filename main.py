...
from your_module import ChatGroq  # Replace with the actual import path for ChatGroq
import voyageai  # Ensure this is the correct import for voyageai.Client
